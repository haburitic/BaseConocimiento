...
public interface GnrAuthorxProjectDAO extends CrudRepository<GnrAuthorxProject, Long> {
	static final Logger log = Logger.getLogger(GnrAuthorxProjectDAO.class);
	...
	public GnrAuthorxProject findByIdprjgnrxprj(long idprjgnrxprj);

	public List<GnrAuthorxProject> findAll();
