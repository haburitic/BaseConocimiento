...
public interface ProjectxLabelDAO extends CrudRepository<ProjectxLabel, Long> {
	static final Logger log = Logger.getLogger(ProjectxLabelDAO.class);
	...
	public ProjectxLabel findByIdnprjxlabel(long idnprjxlabel);

	public List<ProjectxLabel> findAll();
