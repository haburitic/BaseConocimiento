...
public interface AuthorxProjectDAO extends CrudRepository<AuthorxProject, Long> {
	static final Logger log = Logger.getLogger(AuthorxProjectDAO.class);
	...
	public AuthorxProject findByIdnauthorxprj(long idnauthorxprj);

	public List<AuthorxProject> findAll();
