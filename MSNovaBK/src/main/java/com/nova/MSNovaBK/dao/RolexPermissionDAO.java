...
public interface RolexPermissionDAO extends CrudRepository<RolexPermission, Long> {
	static final Logger log = Logger.getLogger(RolexPermissionDAO.class);
	...
	public RolexPermission findByIdnrolexperm(long idnrolexperm);

	public List<RolexPermission> findAll();
