...
public interface GnrProjectDAO extends CrudRepository<GnrProject, Long> {
	static final Logger log = Logger.getLogger(GnrProjectDAO.class);
	...
	public GnrProject findByIdgnrprj(long idgnrprj);

	public List<GnrProject> findAll();
